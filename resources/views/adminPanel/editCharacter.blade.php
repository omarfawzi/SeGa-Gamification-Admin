                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <h4 class="title">Edit Character</h4>

                        </div>

                        <div class="content">

                            <form method="post" action="{{route('editCharacterDB')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-input"
                                                   ...
                                                   name="characterName" value="{{$character->characterName}}" required>
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" name="characterDescription" class="form-control border-input"
                                                      ...
                                                      >{{$character->characterDescription}}</textarea>
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill btn-wd">Update Character</button>

                                    <a href="{{route('deleteCharacter',['characterID'=>$character->characterID])}}" class="btn btn-danger btn-fill btn-wd">Delete Character</a>
                                </div>
